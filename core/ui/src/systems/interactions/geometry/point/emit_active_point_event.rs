...
impl<'a> System<'a> for EmitActivePointEvent {
  type SystemData = (Read<'a, GeometryEventChannel>, Write<'a, ActivePointEventChannel>);
  ...
  fn run(&mut self, (geometry_event_channel, mut active_point_event_channel): Self::SystemData) {
