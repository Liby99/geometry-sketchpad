...
fn main() {
  ...
  let mut dispatcher = DispatcherBuilder::new()
    ...
    .with(interactions::SelectAllViaKeyboard, "select_all_via_keyboard", &[])
    ...
    .with(geometry_actions::SelectAllHandler::default(), "select_all_handler", &["select_all_via_keyboard"])
    ...
    .with(geometry_systems::SelectHandler::default(), "select_handler", &["select_all_handler"])
