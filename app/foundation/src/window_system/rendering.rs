use core_lib::{
  components::{markers::*, screen_shapes::*, styles::*},
  math::*,
  resources::Viewport,
  utilities::*,
};
use piston_window::{
  circle_arc, clear, ellipse, line_from_to, rectangle, Context, Event as PistonEvent, G2d, PistonWindow,
};
use specs::prelude::*;
...
fn render_circle(
  ...
  ellipse(style.fill.into(), rect, context.transform, graphics);
  circle_arc(
